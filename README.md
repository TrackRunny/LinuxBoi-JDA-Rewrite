...
Everything is now set up. To start the bot you can do `java -jar JDA-LearningBot-1.36.10-all.jar` **or** you may want to create a shell or bat script to do this for you.
