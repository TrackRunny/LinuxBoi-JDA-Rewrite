...
public class BlackTwitterMeme implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        final Reddit reddit = kSoftAPI.getRedditImage(ImageType.RANDOM_REDDIT).setSubreddit("BlackPeopleTwitter").execute();
    ...
    public MessageEmbed getHelp() {
        ...
        embedBuilder.setDescription("• Sends out a black twitter meme!");
        embedBuilder.setFooter(Variables.embedFooter);
        embedBuilder.setColor(new Color(Variables.embedColor));
