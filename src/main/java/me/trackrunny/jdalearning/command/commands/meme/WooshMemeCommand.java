...
public class WooshMemeCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        final Reddit reddit = kSoftAPI.getRedditImage(ImageType.RANDOM_REDDIT).setSubreddit("woosh").execute();
    ...
    public MessageEmbed getHelp() {
        ...
        embedBuilder.setDescription("• Sends out a woosh meme!");
        embedBuilder.setFooter(Variables.embedFooter);
        embedBuilder.setColor(new Color(Variables.embedColor));
