...
public class WindowsMemeCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        final Reddit reddit = kSoftAPI.getRedditImage(ImageType.RANDOM_REDDIT).setSubreddit("windowsmemes").execute();
    ...
    public MessageEmbed getHelp() {
        ...
        embedBuilder.setTitle("→ Windows Meme Info");
        embedBuilder.setDescription("• Sends a popular Windows meme from Reddit. ");
        embedBuilder.setFooter(Variables.embedFooter);
