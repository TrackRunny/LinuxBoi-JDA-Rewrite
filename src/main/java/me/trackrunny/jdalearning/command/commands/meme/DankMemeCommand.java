...
public class DankMemeCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        final Reddit reddit = kSoftAPI.getRedditImage(ImageType.RANDOM_REDDIT).setSubreddit("dankmemes").execute();
    ...
    public MessageEmbed getHelp() {
        ...
        embedBuilder.setDescription("• Sends a Dank Meme from Reddit.");
        embedBuilder.setFooter(Variables.embedFooter);
