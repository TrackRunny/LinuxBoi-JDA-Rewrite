...
public class DogFactCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        WebUtils.ins.getJSONObject("https://some-random-api.ml/facts/dog").async((json) -> {
            ...
            embedBuilder.setTitle("→ Dog Fact");
    ...
    public MessageEmbed getHelp() {
        ...
        embedBuilder.setDescription("• Gets a random dog fact.\nUsage: `j!dogfact`");
        embedBuilder.setFooter(Variables.embedFooter);
