...
public class AppleMemeCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        final Reddit reddit = kSoftAPI.getRedditImage(ImageType.RANDOM_REDDIT).setSubreddit("applememes").execute();
    ...
    public MessageEmbed getHelp() {
        ...
        embedBuilder.setDescription("• Sends out an apple meme!");
        embedBuilder.setFooter(Variables.embedFooter);
        embedBuilder.setColor(new Color(Variables.embedColor));
