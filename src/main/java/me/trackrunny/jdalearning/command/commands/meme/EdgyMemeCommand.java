...
public class EdgyMemeCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        final Reddit reddit = Bot.kSoftAPI.getRedditImage(ImageType.RANDOM_REDDIT).setSubreddit("imveryedgy").execute();
    ...
    public MessageEmbed getHelp() {
        ...
        embedBuilder.setDescription("• Sends a edgy meme to the chat");
        embedBuilder.setFooter(Variables.embedFooter);
        embedBuilder.setColor(new Color(Variables.embedColor));
